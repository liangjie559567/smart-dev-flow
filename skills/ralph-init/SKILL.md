...
```
/smart-dev-flow:ralph-init "project or feature description"
```
...
3. **Link to Ralph** so that `/smart-dev-flow:ralph` can use the PRD as its completion criteria
...
```
/smart-dev-flow:ralph "implement the PRD"
```
