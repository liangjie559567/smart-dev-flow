...
Ralplan is a shorthand alias for `/smart-dev-flow:plan --consensus`. It triggers iterative planning with Planner, Architect, and Critic agents until consensus is reached.

## Usage

```
/smart-dev-flow:ralplan "task description"
```
...
```
/smart-dev-flow:plan --consensus <arguments>
```
...
8. On approval: **MUST** invoke `Skill("smart-dev-flow:ralph")` for execution -- never implement directly
